...
const expenseOne = store.dispatch(addExpense({description: 'Rent', amount: 100, createdAt: 0 }));
const expenseTwo = store.dispatch(addExpense({description: 'Coffee', amount: 300, createdAt: -1 }));
const expenseThree = store.dispatch(addExpense({description: 'Car', amount: 400, createdAt: 2 }));
